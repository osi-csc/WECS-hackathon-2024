"""
Django settings for codeher project.
...
SECRET_KEY = 'django-insecure-c=w$ft0-_y&rjakawkw+%fi)#lwu8e16#^+-xjj%c6n9mgz)hn'
...
WSGI_APPLICATION = 'codeher.wsgi.application'
